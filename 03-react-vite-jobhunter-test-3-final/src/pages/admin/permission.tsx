...
const PermissionPage = () => {
  ...
  const columns: ProColumns<IPermission>[] = [
    ...
    },
    {
      ...
      render(dom, entity, index, action, schema) {
        return <p style={{ paddingLeft: 10, fontWeight: 'bold', marginBottom: 0, color: colorMethod(entity?.method as string) }}>{entity?.method || ''}</p>;
      },
    },
    {
      title: 'Module',
  ...
  return (
    <div>
      ...
      <ModalPermission openModal={openModal} setOpenModal={setOpenModal} reloadTable={reloadTable} dataInit={dataInit} setDataInit={setDataInit} />

      <ViewDetailPermission onClose={setOpenViewDetail} open={openViewDetail} dataInit={dataInit} setDataInit={setDataInit} />
    </div>
  );
};
