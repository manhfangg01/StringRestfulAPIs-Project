...
const UserPage = () => {
  ...
  const buildQuery = (params: any, sort: any, filter: any) => {
    ...
    if (clone.email) {
      q.filter = clone.name ? q.filter + ' and ' + `${sfLike('email', clone.email)}` : `${sfLike('email', clone.email)}`;
    }
  ...
  return (
    <div>
      ...
      <ModalUser openModal={openModal} setOpenModal={setOpenModal} reloadTable={reloadTable} dataInit={dataInit} setDataInit={setDataInit} />
